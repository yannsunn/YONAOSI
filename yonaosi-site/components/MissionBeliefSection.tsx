    ...
    <section className="py-20 bg-gradient-to-b from-white to-off-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {problemAreas.map((problem, index) => (
            ...
            >
              ...
              <div className="bg-gradient-to-r from-soft-orange/10 to-pale-green/10 rounded-lg p-3 border-l-3 border-soft-orange">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-soft-orange/20 mb-16"
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-gradient-to-b from-soft-orange/5 to-soft-orange/10 rounded-xl">
            ...
            <div className="text-center p-6 bg-gradient-to-b from-pale-blue/5 to-pale-blue/10 rounded-xl">
            ...
            <div className="text-center p-6 bg-gradient-to-b from-pale-green/5 to-pale-green/10 rounded-xl">
              <div className="text-3xl mb-3">🎯</div>
        ...
        <motion.div
          ...
          className="text-center bg-gradient-to-r from-soft-orange/5 via-pale-blue/5 to-pale-green/5 rounded-2xl p-8 md:p-12 border border-soft-orange/20"
        >
          <div className="mb-8">
