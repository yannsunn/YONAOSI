...
const faqs = [
  {
    ...
    answer: 'はい、初回相談には費用をいただきません。強引な勧誘は一切ありません。相談後、サービスを利用するかはお客様の自由です。お気軽にご相談いただけますので、まずは一度お話をお聞かせください。',
  },
  {
  ...
  },
  {
    ...
    answer: '強制はしませんが、「時間」は取り戻せない資産です。一般的に、早く始めるほど複利の効果を活用できる可能性があります。まずは相談で、あなたの「今」の状況を確認してみませんか？',
  },
]
