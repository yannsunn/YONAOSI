...
const faqs = [
  ...
  },
  {
    ...
    answer: 'そのご心配、よく分かります。でもご安心ください。本当にあなたのためになることだけをお話しします。「今は何もしない方が良い」とお伝えすることもあります。あなたの味方として、一緒に考えさせてください。',
  },
  {
    question: '地方に住んでいても相談できますか？',
    answer: 'もちろんです！すべてオンラインで完結するので、日本全国どこからでも相談可能。全国各地のお客様をサポートしています。オンラインだからこそ、移動時間ゼロで気軽に相談できます。',
  },
  {
    question: '個人情報は安全ですか？',
    answer: 'お客様からの情報は、細心の注意のもとで管理をし、個人情報保護の重要性を理解し、適切な取り扱いを心がけております。ご相談内容におかれましても、必ず本サービスに関連する業務以外での連携は一切行いません。',
  },
  {
